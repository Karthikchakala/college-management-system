...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{assets/screenshots/browser/s3_login_production.png}
\caption{Live Production S3 Static Website Cloud-Only Authentication Interface}
