...
\noindent Educational institutions require reliable, secure, and scalable digital management systems to handle multi-faceted academic operations across students, faculty, and administrative staff \cite{iiitdm_kurnool}. Traditional on-premise campus management infrastructures often suffer from single-point-of-failure vulnerabilities, rigid scaling limitations, and insecure credential handling. 
